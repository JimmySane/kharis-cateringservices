...
const WhatsAppButton = () => {
  const phoneNumber = "233244532451"; // Replace with actual WhatsApp number
  const message = encodeURIComponent("Hello! I'd like to inquire about your catering services.");
